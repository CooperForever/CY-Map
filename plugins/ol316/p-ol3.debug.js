...
goog.inherits(P.Event.PlotDrawEvent, ol.events.Event);
...
//    $("#debugwid").text("activeControlPointId = "+this.activeControlPointId);
...
//    $("#debugwid").text(JSON.stringify(coordinate)+"    "+activeControlPointId);
...
//	$("#debugwid").append("   plotMouseDownHandler   ");
...
//	$("#debugwid").append("   plotMouseMoveHandler   ");
...
//	$("#debugwid").append("   plotMouseUpHandler   ");
